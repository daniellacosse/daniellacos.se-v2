...
export const GITHUB_API_HOST = "api.github.com/users/daniellacosse"
...
export const SOUNDCLOUD_API_HOST = "api.soundcloud.com/users/daniellacosse"
...
export const TUMBLR_API_HOST =
  "api.tumblr.com/v2/blog/daniellacosse.tumblr.com"
...
export const YOUTUBE_CHANNEL = "UUAGXhqiwwgiWkZqK8jdKMgw"

const YOUTUBE_UPLOADS_URL = {
  protocol: "https",
  hostname: YOUTUBE_API_HOST,
  pathname: "/playlistItems",
  query: {
    part: "snippet",
    playlistId: YOUTUBE_CHANNEL,
